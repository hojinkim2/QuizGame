...
public class OnGame extends JFrame implements ActionListener {
    ...
    ImageIcon wrongImage = new ImageIcon(Main.class.getResource("../images/No.png"));
    ImageIcon correctImage = new ImageIcon(Main.class.getResource("../images/Yes.png"));
    ImageIcon testImage = new ImageIcon(Main.class.getResource("../images/Main.jpg"));
    ...
    String setQuiz(int num) {
        ...
        try {
            FileReader fr = new FileReader("quiz_" + g + "_" + num + ".dat");
            int ch;
