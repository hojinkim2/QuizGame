...
public class gameEnding extends JFrame {
    ...
    private Image Background_win = new ImageIcon(Main.class.getResource("../images/Main_win.png")).getImage();
    private Image Background_fail = new ImageIcon(Main.class.getResource("../images/Main_lose.png")).getImage();
