...
public class sideScene extends JFrame {
    ...
    private Image Background_chinese = new ImageIcon(Main.class.getResource("../images/Soccer.jpg")).getImage();
    private Image Background_movie = new ImageIcon(Main.class.getResource("../images/movie.png")).getImage();
    private Image Background_java = new ImageIcon(Main.class.getResource("../images/Game.png")).getImage();
    private Image Background_common = new ImageIcon(Main.class.getResource("../images/상식.png")).getImage();
